...
execute if entity @s[advancements={hologram_ui:operator=true}] at @e[type=marker,tag=hologram_ui.basepoint,distance=..1,sort=nearest,limit=1] run function hologram_ui:load_menu/
