...
tag @s add hologram_ui_light.this
  execute if entity @a[advancements={hologram_ui_light:operator=true},tag=!hologram_ui_light.this,distance=..1] run function hologram_ui_light:create/cancel/by_other_player
