...
#@public
  ...
  scoreboard objectives add hologram_ui_light.menu dummy
...
## デフォルトメニューidのロード
execute store result score @s hologram_ui_light.menu run data get entity @e[type=marker,tag=hologram_ui_light.basepoint,distance=..0.01,limit=1] data.default
